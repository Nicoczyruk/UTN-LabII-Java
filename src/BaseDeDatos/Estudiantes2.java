...
public class Estudiantes2 {
    public static void main(String[] args) {
        ...
        String url = "jdbc:mysql://localhost:33061/universidad";
        String usuario = "root";
        String pass = "";
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("6. Traer por edad");
    ...
    private static void traerPorEdad(Connection conexion, Scanner scanner) throws SQLException {

        System.out.println("Ingrese a partir de que edad desea traer: ");
        ...
        String consulta = "SELECT " +
                ...
                "email " +
                "FROM estudiantes " +
                "WHERE YEAR(CURRENT_DATE()) - YEAR(fecha_nacimiento) > ?";
